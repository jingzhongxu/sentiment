...
class ProcessCorpus:
	...
	def getPosNegAttributes(self):
		...
		'''test'''
		# print(len(negParagraphList))
		# print(len(posParagraphList))
		# print(negParagraphList[0])
		# print(posParagraphList[0])
		# print(len(self.sentimentword))
...
def main():
	...
	# obj.classtest()
	# with open("./pickle/fre4train.pickle","wb") as fw:
	# 	pickle.dump(obj,fw)
